...
public class Activity_SetQQGroup extends BaseActivity{
    ...
    private class MyCallback implements Adapter_SetGroup.OnCallback{
        ...
        public void deleteEvent(final String groupNameStr) {
            DialogFactory dialog = DialogFactory.getInstance(Activity_SetQQGroup.this);
        ...
        public void onClick(View v) {
            switch(v.getId()){
                ...
                case R.id.addGroup:
                    ...
                    groupName.setText("");
                    Utils_Static.closeInputMethod(Activity_SetQQGroup.this);
    ...
    public static void startActivity(Activity activity) {
        Intent intent = new Intent(activity, Activity_SetQQGroup.class);
